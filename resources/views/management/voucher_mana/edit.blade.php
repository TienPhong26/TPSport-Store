                        ...
                        <form action="{{ route('admin.voucher.update', $voucher->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror" id="code"
                                    name="code" value="{{ old('code', $voucher->code) }}" required>
                                @error('code')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('discount_amount', $voucher->discount_amount) }}" min="0"
                                            step="1000">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('discount_percentage', $voucher->discount_percentage) }}" min="0"
                                            max="100" step="0.1">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('max_usage_count') is-invalid @enderror"
